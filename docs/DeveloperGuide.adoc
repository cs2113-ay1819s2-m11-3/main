...
The user can set a deadline for the flashcards and determine how long the flash cards will exist in the database “FlashCards”.
...
he/she can choose to assign a date or write a note under the flashcard, for example, `Clarify with the Teacher` or `Edit photosynthesis`. This will allow the user to have the freedom to write whatever they require rather than just deadlines.
...
** Pros: Auto deletion of flash cards. Convenient for users as they do not have to keep track.
** Cons: Need to pay extra caution for Leap years. Users also do not have the choice of keeping flashcards after the deadline.
...
the user will have better control over what they want to store or delete in the application.
